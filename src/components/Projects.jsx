  ...
  return (
    <>
        ...
        <div className="projects">
            ...
            <img loading='lazy' src="./FilmLibraryApp.png" alt="Film Library App Screenshot" />
            ...
            <img loading='lazy' src="./WeatherApp.png" alt="Weather App Screenshot" />
                <h3>Weather App</h3>
            ...
            <img loading='lazy' src="./TodoListApp.png" alt="To Do List App Screenshot" />
        ...
        <div className="strip">
        <h1>AN ENTHAUSIASTIC MERN WEB DEVELOPER </h1>
        </div>
    </>
  )
}
